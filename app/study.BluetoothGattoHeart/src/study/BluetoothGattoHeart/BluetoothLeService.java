...
public class BluetoothLeService extends Service implements IoInterface {
    ...
    String READDATA = "00";
    String [] read_data = new String[512];
    int d =0;
...
//                		.getService(UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb"));						
...
//							.getCharacteristic(UUID.fromString("00002a19-0000-1000-8000-00805f9b34fb"));
    ...
    private void broadcastUpdate(final String action,
		...
		if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
			...
			Log.e(TAG, "For all other profiles, writes the data formatted in HEX.");
